...
base_dirs = {
    ...
    "MR1": os.path.join("data_mr1", model_name)
}
...
# -------------------------------------
# Setup 3x2 plot grid and sliders
# -------------------------------------
...
for row, group_name in enumerate(["Original", "MR1"]):
    for col, scenario in enumerate(scenarios):
        ...
        slider_y = 0.08 if row == 0 else 0.02
        sa = plt.axes([slider_x, slider_y, 0.22, 0.03])
        slider = Slider(
            ax=sa,
